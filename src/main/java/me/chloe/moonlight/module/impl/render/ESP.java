...
import me.chloe.moonlight.module.impl.client.HUD;
import me.chloe.moonlight.util.render.OutlineUtils;
...
public class ESP extends Module {
    ...
    private void drawText(final Entity entityIn) {
        ...
        if (HUD.INSTANCE.customFont.getValue()) {
            Moonlight.fontUtil.drawStringWithShadow(str, -i, 9, Color.WHITE.getRGB());
        } else {
