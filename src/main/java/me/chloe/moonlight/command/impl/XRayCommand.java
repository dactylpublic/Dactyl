...
public class XRayCommand extends Command {
    ...
    private void handleIncorrectUsage() {
        ...
        ChatUtil.printMsg("Usage: "+ Moonlight.commandManager.getPrefix() +"xray <add/del> <blockname>", true, false);
    }
    ...
    private void handleAddBlock(String[] args) {
        ...
        if(!Moonlight.xRayManager.hasBlock(Block.getBlockFromName(args[2]))) {
            Moonlight.xRayManager.addBlock(args[2]);
    ...
    private void handleRemoveBlock(String[] args) {
        if(Moonlight.xRayManager.hasBlock(Block.getBlockFromName(args[2]))) {
            Moonlight.xRayManager.removeBlock(args[2]);
