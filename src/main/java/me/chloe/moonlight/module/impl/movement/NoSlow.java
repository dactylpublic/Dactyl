...
import me.chloe.moonlight.event.impl.action.KeyboardMoveEvent;
...
public class NoSlow extends Module {
    ...
    private void handleSoulSandSlowdown(MoveEvent event) {
        if(mc.currentScreen == Moonlight.clickGUI || Freecam.INSTANCE.isEnabled()) {
            return;
        }
    ...
    private void handleWebXZMovement(MoveEvent event) {
        ...
        if(mc.currentScreen == Moonlight.clickGUI) {
            return;
        }
