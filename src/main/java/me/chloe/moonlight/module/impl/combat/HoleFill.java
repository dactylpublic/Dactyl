...
public class HoleFill extends Module {
    ...
    private boolean isValidHole(BlockPos pos) {
        ...
        if(smart.getValue()) {
            List<Entity> playerEntities = new ArrayList<>(mc.world.playerEntities.stream().filter(entityPlayer -> !Moonlight.friendManager.isFriend(entityPlayer.getName())).collect(Collectors.toList()));
            EntityPlayer p = null;
