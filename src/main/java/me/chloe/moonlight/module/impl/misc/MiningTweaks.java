...
import me.chloe.moonlight.event.impl.world.ClickBlockEvent;
import me.chloe.moonlight.event.impl.world.DamageBlockEvent;
import me.chloe.moonlight.event.impl.world.Render3DEvent;
import me.chloe.moonlight.event.impl.world.ResetBlockRemovingEvent;
...
public class MiningTweaks extends Module {
    ...
    public void onRender3D(Render3DEvent event) {
        ...
        if (renderPacketBlock.getValue() && this.currentPos != null && (modeSetting.getValue() == MiningMode.PACKET || modeSetting.getValue() == MiningMode.BYPASS)) {
            Color color = new Color(this.timer.hasPassed((int)(2000.0f * (20F / Moonlight.tickRateManager.getTickRate()))) ? 0 : 255, this.timer.hasPassed((int) (2000.0f * (20F / Moonlight.tickRateManager.getTickRate()))) ? 255 : 0, 0, 255);
            if(this.timer.hasPassed((int) (2000.0f * (20F / Moonlight.tickRateManager.getTickRate())))) {
            ...
            if(!renderBreakProgress.getValue()) {
                ...
                double passedOffset = timer.getPassedTime() / ((2000.0f * (20F / Moonlight.tickRateManager.getTickRate())));
