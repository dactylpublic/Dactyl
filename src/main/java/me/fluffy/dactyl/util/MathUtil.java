...
public class MathUtil {
    ...
    public static double[] directionSpeedNoForwardYaw(double speed, float rotationYaw) {
        final Minecraft mc = Minecraft.getMinecraft();
        float forward = 1f;
    ...
    // after this is TrajectoryUtils from Ares-Client
    /*
     * @author Tigermouthbear 10/4/20
     * https://github.com/AresClient/ares/blob/master/ares-forge/src/main/java/dev/tigr/ares/forge/utils/TrajectoryUtils.java
     */
