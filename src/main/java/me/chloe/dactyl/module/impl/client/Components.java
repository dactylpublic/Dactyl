...
import me.chloe.dactyl.module.impl.combat.Killaura;
import me.chloe.dactyl.module.impl.render.Nametags;
import me.chloe.dactyl.setting.Setting;
import me.chloe.dactyl.util.EntityUtil;
...
public class Components extends Module {
    ...
    private Entity getClosestTarget() {
        ...
        if(t == null) {
            if(targetHudPrio.getValue() == me.chloe.dactyl.module.impl.client.Components.THudPrio.CAURA && Killaura.INSTANCE != null) {
                t = mc.world.getPlayerEntityByName(Killaura.INSTANCE.getModuleInfo());
            } else if(targetHudPrio.getValue() == me.chloe.dactyl.module.impl.client.Components.THudPrio.KAURA) {
                t = getClosest();
        ...
        if(t == null) {
            if(targetHudPrio.getValue() == me.chloe.dactyl.module.impl.client.Components.THudPrio.CAURA) {
                t = getClosest();
            } else if(targetHudPrio.getValue() == me.chloe.dactyl.module.impl.client.Components.THudPrio.KAURA && AutoCrystal.INSTANCE != null) {
                t = mc.world.getPlayerEntityByName(AutoCrystal.INSTANCE.getModuleInfo());
